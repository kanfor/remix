...
public class Font {
   ...
   public static final float FNT_SIZE_PROPORTION [] = {0.75f, 1.0f, 1.5f, 2.0f};
   public static final float FNT_SIZE_SMALL = 16 * FNT_SIZE_PROPORTION[Settings.ms_iSize];
   public static final float FNT_SIZE_MEDIU = 24 * FNT_SIZE_PROPORTION[Settings.ms_iSize];
   public static final float FNT_SIZE_LARGE = 32 * FNT_SIZE_PROPORTION[Settings.ms_iSize];
   ...
   private static Font DEFAULT_FONT = new Font(FACE_SYSTEM, STYLE_PLAIN, SIZE_SMALL);
