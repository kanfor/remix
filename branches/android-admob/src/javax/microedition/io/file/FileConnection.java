...
public interface FileConnection extends javax.microedition.io.Connection, InputConnection,
	 ...
	 boolean isOpen();
	 long lastModified();
	 java.util.Enumeration<String> list() throws IOException; 
	 java.util.Enumeration<String> list(java.lang.String filter, boolean includeHidden) throws IOException; 
