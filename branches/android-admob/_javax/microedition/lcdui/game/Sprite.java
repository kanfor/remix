...
public class Sprite extends Layer
{
    ...
    public Sprite(Image image) {
        ...
        initializeFrames(image.getBitmap(), image.getWidth(), image.getHeight(), false);
    ...
    public Sprite(Image image, int frameWidth, int frameHeight) {
        ...
        mPaint = new Paint();
        mPaint.setAntiAlias(ActivityMain.DRAW_ANTIALIASING);
        mSrcRect = new Rect();
        mDestRect = new Rect();
        ...
        initializeFrames(image.getBitmap(), frameWidth, frameHeight, false);
...
//    public void setImage(Image img, int frameWidth, int frameHeight) {
    ...
    public final boolean collidesWith(Image image, int inp_x, int inp_y, boolean pixelLevel) {
    	return collidesWith(image.getBitmap(), inp_x, inp_y, pixelLevel);
    }
    
    public final boolean collidesWith(Bitmap image, int inp_x, int inp_y, boolean pixelLevel) {
